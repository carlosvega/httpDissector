...
//  fprintf(stderr, "\t    --gc-output=<file>\t\tOutput file for the garbage collector. Writes the requests without responses in the given file.\n");
  ...
  fprintf(stderr, "\tSourceIP|SourcePort|DestIP|DestPort|ReqTS|ResTS|Diff|ResponseMSG|ResponseCode|RequestMethod|Agent|Host|URL\n");
  ...
  fprintf(stderr, "One file path per line with absolute paths.\n");
